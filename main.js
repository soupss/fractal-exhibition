...
var ASM_CONSTS = {
  156960: ($0, $1) => { const fps = $0; const t = $1; document.getElementById('fps-counter').innerText = Math.round(fps); let list = window.fps_list; list.push([fps, t]); if (list.length > 400) { list.shift(); } },  
 157152: () => { if (typeof GPUQueue !== 'undefined' && GPUQueue.prototype.writeBuffer) { const originalWriteBuffer = GPUQueue.prototype.writeBuffer; GPUQueue.prototype.writeBuffer = function(buffer, bufferOffset, data, dataOffset, size) { return originalWriteBuffer.call(this, buffer, typeof bufferOffset === 'bigint' ? Number(bufferOffset) : bufferOffset, data, typeof dataOffset === 'bigint' ? Number(dataOffset) : dataOffset, typeof size === 'bigint' ? Number(size) : size ); }; } }
};
...
// end include: preamble.js
  ...
  var _wgpuQueueWriteBuffer = (queueId, bufferId, bufferOffset, data, size) => {
      var queue = WebGPU.mgrQueue.get(queueId);
...
var _build_pipelines = Module['_build_pipelines'] = createExportWrapper('build_pipelines', 0);
...
var ___emscripten_embedded_file_data = Module['___emscripten_embedded_file_data'] = 151168;
